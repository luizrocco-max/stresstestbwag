...
def main(argv=None):
    ...
    r.add_argument("--cenarios", default=None, help="YAML de cenários (padrão: o embutido no pacote)")
    ...
    e.add_argument("universo", nargs="?", default=str(Path(__file__).resolve().parent / "universo.yaml"))
